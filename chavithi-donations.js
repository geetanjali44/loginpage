const chavithiForm = document.getElementById("chavithiForm");
...
chavithiForm.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    let donations = JSON.parse(localStorage.getItem("chavithiDonations")) || [];

    donations.push(donation);

    localStorage.setItem("chavithiDonations", JSON.stringify(donations));

    alert("Thank you! Your Chavithi donation details submitted 🙏");
